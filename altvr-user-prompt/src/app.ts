...
export default class EmailCapture {
	...
	private async signUp(user: MRE.User) {
		...
		// PROMPT FOR EMAIL
		this.userInput = await user.prompt("Escribe tu email:", true);
		...
		return await user.prompt("¡Enhorabuena, te has registrado correctamente!\nTe enviaremos ofertas especiales para ti.");
    }
